...
REM ***************************************************************************
REM
REM File name...: distinct_placement.sql
REM Author......: Christian Antognini
REM Date........: February 2013
REM Description.: This script provides examples of the "distinct placement" 
...
ALTER SESSION SET tracefile_identifier = 'distinct_placement';


REM the number of distinct values of t2.n1 is low --> transformation done

ALTER SESSION SET events '10053 trace name context forever';
EXPLAIN PLAN FOR SELECT DISTINCT t1.n2, t2.n1 FROM t1, t2 WHERE t1.id = t2.t1_id;
ALTER SESSION SET events '10053 trace name context off';
SELECT * FROM table(dbms_xplan.display(NULL, NULL, 'basic rows'));

ALTER SESSION SET events '10053 trace name context forever';
EXPLAIN PLAN FOR SELECT /*+ no_place_distinct(@sel$1 t2@sel$1) */ DISTINCT t1.n2, t2.n1 FROM t1, t2 WHERE t1.id = t2.t1_id;
ALTER SESSION SET events '10053 trace name context off';
SELECT * FROM table(dbms_xplan.display(NULL, NULL, 'basic rows'));
...
ALTER SESSION SET events '10053 trace name context forever';
EXPLAIN PLAN FOR SELECT DISTINCT t1.n2, t2.n2 FROM t1, t2 WHERE t1.id = t2.t1_id;
ALTER SESSION SET events '10053 trace name context off';
SELECT * FROM table(dbms_xplan.display(NULL, NULL, 'basic rows'));

ALTER SESSION SET events '10053 trace name context forever';
EXPLAIN PLAN FOR SELECT /*+ place_distinct(@sel$1 t2@sel$1) */ DISTINCT t1.n2, t2.n2 FROM t1, t2 WHERE t1.id = t2.t1_id;
ALTER SESSION SET events '10053 trace name context off';
SELECT * FROM table(dbms_xplan.display(NULL, NULL, 'basic rows'));
