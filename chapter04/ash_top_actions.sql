...
REM ***************************************************************************
REM
REM File name...: ash_top_actions.sql
...
COLUMN service FORMAT A22 TRUNCATE HEADING "Service"
COLUMN module FORMAT A22 TRUNCATE HEADING "Module"
COLUMN action FORMAT A21 TRUNCATE HEADING "Action"
...
FROM (
  ...
  GROUP BY service_hash, module, action
  ORDER BY sum(1) DESC
) ash
WHERE rownum <= 10;
